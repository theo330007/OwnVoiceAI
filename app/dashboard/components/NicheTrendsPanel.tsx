...
export function NicheTrendsPanel({ initialTrends }: Props) {
      ...
      <div className="space-y-4">
        {trends.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-sage/50 mb-4">No niche trends yet.</p>
            <a
              href="/admin/trends"
          ...
          trends.map((trend) => (
            <div
              ...
              className="p-4 bg-dusty-rose/5 rounded-2xl hover:bg-dusty-rose/10 transition-all cursor-pointer hover:shadow-soft group"
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                  {trend.relevance_score && (
                    <span className="px-2 py-1 bg-dusty-rose/20 text-dusty-rose text-xs font-bold rounded-full">
                      {trend.relevance_score}
                    </span>
                  )}
                  {trend.trend_type && (
