    ...
    <div className="max-w-2xl mx-auto py-12 px-6">
      <div className="bg-white rounded-3xl shadow-soft p-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-sage mb-1.5">What you refuse to do</label>
            <textarea
              value={data.content_boundaries}
              onChange={(e) => onChange({ content_boundaries: e.target.value })}
              rows={3}
              ...
              placeholder="Content lines you won't cross..."
            />
          </div>
